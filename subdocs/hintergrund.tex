...
Unter dem Begriff Gamification wird der Einsatz von Spielmechaniken und Spieldesignelementen in einem spielfremden Kontext, z.B. einem Lern- oder Arbeitsprozess, verstanden \cite{deterding_game_2011}. Gemeint ist damit die Integration von dem, was ein Spiel ausmacht (Abzeichen, Level, Erfahrungspunkte, Trophäen), in eine gänzlich spielfremde Tätigkeit, wie etwa dem Lernen, der Arbeit oder in den Haushalt. Zwei praktische Beispiele aus der Realität sind Duolingo und Reddit. So schaltet der Nutzer auf der Lernplattform Duolingo, die dem interaktiven Vermitteln von Sprachkenntnissen dient, ständig neue Lektionen als Belohnung für den Abschluss bisheriger Lektionen frei. Der Social-News-Aggregator Reddit integriert hingegen ein ausgeklügeltes Punktesystem. Nutzer können auf der Plattform durch das regelmäßige Posten qualitativ hochwertiger Beiträge \qq{Karmapunkte} sammeln. Gleichzeitig ist es für jeden Nutzer möglich, eben diese Beiträge mit einem \qq{Down-Vote} oder einem \qq{Up-Vote} zu bewerten. Ziel ist es, dass sich Nutzer freiwillig mehr engagieren, um ihr Ansehen in der Community zu steigern.

In der Gamification wird zwischen den Begriffen \textit{Game} und \textit{Play} unterschieden - Zwei Begriffe, die es so im Deutschen nicht gibt. \textit{Game} meint dabei ein Spiel mit festen Zielen und Regeln, während \textit{Play} das freie, regellose und improvisierte Spielen bezeichnet. Der Begriff \textit{Play} ist damit deutlich weiter gefasst und schließt das \textit{Game} ein. So kann man sich als Beispiel für den Begriff \textit{Play} das übermütige, ausgelassene Umherspringen von Kindern vorstellen,  während ein \textit{Game} sich durch seine Ziel- und Regelgebundenheit auszeichnet, etwa ein Fußballspiel. Derartige Spielen müssen dabei nicht zwangsläufig Spaß bringen oder der reinen Unterhaltung dienen. Für den professionellen Fußballspieler dient das Fußballspiel vielmehr als  Existenzgrundlage als der bloßen Unterhaltung. 
...
Diese Spielelemente wirken positiv auf das individuell wahrgenommene Gefühl von Vergnügen, Fluss, Autonomie und Leistung und erhöhen somit die intrinsische Motivation des Nutzers \cite{ryan2006motivational}.
